...
export function VerifyPage() {
  const { questId } = useParams(); const navigate = useNavigate(); const location = useLocation(); const goBack = useBackTo(`/quests/${questId}`); const recoverSession = useSessionRecovery();
